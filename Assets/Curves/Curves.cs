...
public sealed class Curves
{
    ...
    /// <summary>
    /// Evaluate the value in y at t [0,1] given the start and end handles
    /// </summary>
    /// <param name="start">Y start value</param>
    /// <param name="startHandle">Position of the first handle</param>
    /// <param name="end">Y end value</param>
    /// <param name="endHandle">Position of the end handle</param>
    /// <param name="t">Porgression</param>
    /// <returns>Evaluation of the value in y at t on the bezier curve</returns>
    ...
    /// <summary>
    /// Evaluate the value in y at t [0,1] given the start and end weights (Y value of the bezier handles aligned vertically with their points)
    /// </summary>
    /// <param name="start">Y start value</param>
    ...
    /// <param name="t">Porgression</param>
    /// <returns>Evaluation of the value in y at on the bezier curve</returns>
